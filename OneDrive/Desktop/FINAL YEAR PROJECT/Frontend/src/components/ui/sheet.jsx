...
const Sheet = React.forwardRef(function Sheet(props, ref) {
  return <SheetPrimitive.Root data-slot="sheet" {...props} ref={ref} />;
});

const SheetTrigger = React.forwardRef(function SheetTrigger(props, ref) {
  return <SheetPrimitive.Trigger data-slot="sheet-trigger" {...props} ref={ref} />;
});

const SheetClose = React.forwardRef(function SheetClose(props, ref) {
  return <SheetPrimitive.Close data-slot="sheet-close" {...props} ref={ref} />;
});

const SheetPortal = React.forwardRef(function SheetPortal(props, ref) {
  return <SheetPrimitive.Portal data-slot="sheet-portal" {...props} ref={ref} />;
});
