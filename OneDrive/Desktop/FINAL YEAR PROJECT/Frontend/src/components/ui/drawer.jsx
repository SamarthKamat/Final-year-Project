...
const Drawer = React.forwardRef(function Drawer(props, ref) {
  return <DrawerPrimitive.Root data-slot="drawer" {...props} ref={ref} />;
});

const DrawerTrigger = React.forwardRef(function DrawerTrigger(props, ref) {
  return <DrawerPrimitive.Trigger data-slot="drawer-trigger" {...props} ref={ref} />;
});

const DrawerPortal = React.forwardRef(function DrawerPortal(props, ref) {
  return <DrawerPrimitive.Portal data-slot="drawer-portal" {...props} ref={ref} />;
});

const DrawerClose = React.forwardRef(function DrawerClose(props, ref) {
  return <DrawerPrimitive.Close data-slot="drawer-close" {...props} ref={ref} />;
});
